    ...
    public void power_up() {
        try {
            ...
            for(;;) {
                ...
                if(!UserArray.getUserName(0).equals(stringFromUser)) {
                    ...
                    outToClient1.writeBytes("Server| " + userName2 + " is ready to chat whit you\n");
                    outToClient2.writeBytes("Server| " + userName1 + " is ready to chat whit you\n");
                    break;
                }
                else
